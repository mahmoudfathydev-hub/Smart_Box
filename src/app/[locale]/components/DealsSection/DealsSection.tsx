  ...
  useEffect(() => {
    const fetchDealsProducts = async () => {
      try {
        ...
        const dealsProducts = await ProductRepository.getProductsOnSale(8);
    ...
    return (
      <section className="w-full py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center py-12">
            <p className="text-gray-600">{dictionary.empty}</p>
          </div>
        </div>
      </section>
    );
  ...
  return (
    <section className="w-full py-16 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Swiper Container */}
        <ProductSwiper products={products} isRTL={isRTL} />
      </div>
    </section>
  );
}
